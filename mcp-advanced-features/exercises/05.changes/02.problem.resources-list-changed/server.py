...
async def create_entry(
    ...
    # 🐨 the epicme://entries collection just gained a row, but the client's cached
    #    listing doesn't know it. Tell it the collection changed:
    #      await ctx.session.send_resource_list_changed()
    raise NotImplementedError("Announce the change with ctx.session.send_resource_list_changed()")
...
async def create_tag(
    ...
    # 🐨 the epicme://tags collection just gained a row, but the client's cached
    #    listing doesn't know it. Tell it the collection changed:
    #      await ctx.session.send_resource_list_changed()
    raise NotImplementedError("Announce the change with ctx.session.send_resource_list_changed()")

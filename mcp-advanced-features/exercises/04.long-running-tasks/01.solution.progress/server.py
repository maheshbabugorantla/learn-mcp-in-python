"""EpicMe MCP server — long-running tasks: progress (solution).
...
async def create_wrapped_video(
    ...
    async def on_progress(fraction: float) -> None:
        # Each step of the render calls this; forward it to the client as a
        # progress notification the caller can turn into a bar.

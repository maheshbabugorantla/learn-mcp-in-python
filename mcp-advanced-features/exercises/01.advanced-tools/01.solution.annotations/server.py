"""EpicMe MCP server — tool annotations (solution).
...
Every tool here carries a `ToolAnnotations`. The hints are advisory (a client
may ignore them), but they're how a well-behaved client decides how much
ceremony a call deserves.
"""

...
# scopes this server understands, every single tool would fail. Better to say so
# once, at the door, than five times in a row.
#
# After you have the auth_info and before you set the ContextVar:
#
...
async def authorize(request: Request) -> Response | None:
    ...
    In order, and the order is the point:
      ...
      2. Who is it?                   -> stash it where the tools can find it

...
from auth import fetch_user, require_auth_info
...
#
#   whoami            -> require_scope("user:read")
#   create_entry      -> require_scope("entries:write")
#   get_entry         -> require_scope("entries:read")
#   list_entries      -> require_scope("entries:read")
#   create_tag        -> require_scope("tags:write")
#   add_tag_to_entry  -> require_scope("entries:write", "tags:read")
#   epicme://user     -> require_scope("user:read")
#   epicme://tags     -> require_scope("tags:read")
#   epicme://entries  -> require_scope("entries:read")
#   epicme://entries/{id} -> require_scope("entries:read")
#   suggest_tags      -> require_scope("entries:read", "tags:read")
#
# Raise, rather than returning an HTTP error: the request was fine and the
# client is who it says it is — this one tool wasn't allowed. Name the missing
# scope so the model can say something better than "it didn't work".

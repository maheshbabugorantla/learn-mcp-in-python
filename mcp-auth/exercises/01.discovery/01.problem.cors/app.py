...
#
# Return None for anything that isn't a `/.well-known` URL — /mcp is not
# browser-facing, and handing out CORS headers you don't need is how origins you
# never thought about end up able to call your server.
#
# For /.well-known URLs, return these three:
#
#   "Access-Control-Allow-Origin": "*"
#       We can't know every origin that might want to read our metadata, and
#       there's nothing secret in it — it's a public description of how to log
#       in. So: anyone.
#
#   "Access-Control-Allow-Methods": "GET, HEAD, OPTIONS"
#       Reading metadata is all anyone needs to do here.
#
#   "Access-Control-Allow-Headers": "mcp-protocol-version"
#       Clients are supposed to send this on every request. Not all do, but
#       allowing it costs nothing.
#
# `WithCors` at the bottom of this file does the rest: it answers OPTIONS
# preflights and copies your headers onto every response.

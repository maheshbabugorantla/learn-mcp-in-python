"""EpicMe MCP server — 05.prompts / prompts (solution)."""
...
# The argument arrives as a string no matter what — prompt arguments are strings
# on the wire — so take a `str` and convert when you need a number.
@mcp.prompt(
    name="suggest_tags",

"""EpicMe MCP server — 05.prompts / completion (solution)."""
...
async def handle_completion(
    ...
    # One handler for the whole server, so the first job is always working out
    # what is being completed. `ref` tells you whether it's a prompt argument
    # or a slot in a resource template.

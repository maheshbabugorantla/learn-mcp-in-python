"""EpicMe MCP server — sizing (problem).
    ...
    return CallToolResult(
        content=[
            create_ui_resource(
                ...
                # 🐨 add ui_metadata with a "preferred-frame-size" of
                #    ["600px", "800px"] (a [width, height] pair) so the host
                #    sizes the frame before the page loads.
            )
        ]
    )

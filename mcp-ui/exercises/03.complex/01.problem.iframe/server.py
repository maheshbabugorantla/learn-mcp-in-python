"""EpicMe MCP server — iframe (problem).
...
def view_journal() -> CallToolResult:
    ...
    # 🐨 build an iframe URL for the page your demo serves at /ui/journal-viewer:
    #    iframe_url = f"{BASE_URL}/ui/journal-viewer"
    # 🐨 return a CallToolResult with one UI resource:
    #    create_ui_resource(
    #        uri=f"ui://view-journal/{int(time.time() * 1000)}",
    #        content={"type": "externalUrl", "iframeUrl": iframe_url},
    #    )
    # 💣 delete this placeholder once you do:
    raise NotImplementedError("Return an externalUrl UI resource (see the TODO).")
